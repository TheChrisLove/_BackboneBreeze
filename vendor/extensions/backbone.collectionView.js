    ...
    Backbone.CollectionView = Backbone.View.extend({
                ...
                switch (changedOptionKey) {
                    ...
                    case "selectMultiple":
                        if (!newVal && _this.selectedItems.length > 1)
                            _this.setSelectedModel(_.first(_this.selectedItems), {
                                by: "cid"
                            });
                        break;
                    case "selectable":
        ...
        _getContainerEl: function() {
            if (this._isRenderedAsTable()) {
                ...
                var tbody = this.$el.find("> tbody:eq(0)");
                if (tbody.length > 0)
                    return tbody;
            }
            return this.$el;
        ...
        _restoreSelection: function() {
            ...
            if (this.savedSelection.items.length > 0) {
                ...
                if (this.selectedItems.length === 0)
                    this.setSelectedModel(this.savedSelection.offset, {
                        by: "offset"
                    });
            ...
            if (clickedItemId) {
                ...
                if (this.selectMultiple && theEvent.shiftKey) {
                    ...
                    if (_.contains(this.selectedItems, clickedItemId))
                        this.setSelectedModels(_.without(this.selectedItems, clickedItemId), {
                            by: "cid"
                        });
                    ...
                    this.setSelectedModels([clickedItemId], {
                        by: "cid"
                    });
            } else
